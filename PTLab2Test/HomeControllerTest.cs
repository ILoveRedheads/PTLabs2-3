...
namespace PTLab2Test
{
    public class HomeControllerTest
    {
        ...
        [Fact]
        // Тест на скидку в день рождения
        ...
        public async Task TestUpdateProducts()
        {
            ...
            Assert.Equal(22,5, products[0].Price);
        }
        ...
        public async Task TestAmount()
        {
            ...
            Assert.Equal(22,5, db.Basket.Last().Amount);
        }

        [Fact]
        // Тест на размер скидки товара
